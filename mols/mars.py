...
parser.add_argument("--proxy_path", default='mols/data/pretrained_proxy')#data/pretrained_proxy//info.pkl.gz
...
class Dataset:
    ...
    def sample(self, n):
        print(f"self.train_mols:{self.train_mols}")
